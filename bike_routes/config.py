...
# Citi Bike account export, normalised by ingest.citibike, plus the GBFS
# station list it resolved dock names against. Neither is matcher input --
# these trips have no GPS trace -- so neither is in _processing_config().
